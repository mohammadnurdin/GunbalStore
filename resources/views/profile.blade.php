            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="no_telp" class="form-control" placeholder="Phone Number" value="{{ auth()->user()->no_telp }}">
                    </div>
                    <div class="col-md-6">
                        <label class="labels">Address</label>
                        <input type="text" name="alamat" class="form-control" value="{{ auth()->user()->alamat }}" placeholder="Address">
                    </div>
                </div>
