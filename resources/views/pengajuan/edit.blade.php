            ...
            <form action="{{ route('pengajuan.update', $pengajuan->id) }}" method="POST">
                ...
                <div class="form-group">
                    <label for="id_pelanggan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                        Pelanggan</label>
                    <input type="text" name="nama_pelanggan" value="{{ $pengajuan->pelanggan->nama_pelanggan }}"
                ...
                <div class="form-group">
                    <label for="tgl_pemasangan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal
                        Pemasangan</label>
                    <input type="date" id="tgl_pemasangan" name="tgl_pemasangan" value="{{ $pengajuan->tgl_pemasangan }}"
                        class="form-control" required autofocus>
                </div>
