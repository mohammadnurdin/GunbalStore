                    ...
                    <form action="{{ route('detailpengajuan.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <label for="id_barang">{{$brg->nama_barang}}</label><br>
                            </div> 
                            @endforeach
                        
            
                            {{-- <label for="vehicle1">Konektor</label><br>
                            <label for="vehicle1">Htb A</label><br>
                            <label for="vehicle1">Htb B</label><br>
                            <label for="vehicle1">Router</label><br> --}}
